...
export const AccessibilityControls = () => {
  ...
  useEffect(() => {
    ...
    const savedFontSize =
      (localStorage.getItem("fontSize") as typeof fontSize) || "normal";
    ...
    <>
      ...
      {isOpen && (
        <>
          ...
          {/* Painel */}
          <div className="fixed bottom-24 left-6 z-50 bg-card border border-border rounded-xl shadow-2xl p-6 w-80 animate-in slide-in-from-bottom-4 fade-in duration-300">
