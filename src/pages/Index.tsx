...
import { BookOpen, Target, Zap, TrendingUp, Users, Code } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="space-y-6 text-muted-foreground">
          <p className="text-lg">
            Modelos de linguagem como ChatGPT, Claude, Gemini e outros transformaram tarefas complexas em conversas simples. 
            Porém, existe um segredo para extrair o máximo dessas ferramentas: <strong className="text-foreground">saber formular bons prompts</strong>.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 my-8">
            <div className="p-6 bg-card border border-border rounded-lg">
              ...
              <p className="text-sm">
                É a prática de projetar e refinar instruções para modelos de IA gerarem respostas úteis, 
                precisas e relevantes. Não se trata apenas de fazer perguntas, mas de construir comandos estratégicos.
              </p>
            </div>
            ...
            <div className="p-6 bg-card border border-border rounded-lg">
              ...
              <p className="text-sm">
                Economia de tempo, resultados superiores, versatilidade e diferencial profissional. 
                Quem domina essa habilidade se destaca no mercado atual.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-primary/10 to-accent/10 p-6 rounded-lg border border-primary/20">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span><strong className="text-foreground">Economia de tempo:</strong> Respostas corretas na primeira tentativa</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary mt-1">✓</span>
                <span><strong className="text-foreground">Resultados superiores:</strong> Soluções personalizadas para problemas específicos</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary mt-1">✓</span>
                <span><strong className="text-foreground">Versatilidade:</strong> Aplicável desde planos de aula até códigos de programação</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary mt-1">✓</span>
                <span><strong className="text-foreground">Diferencial profissional:</strong> Destaque no mercado de trabalho</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              A clareza é o pilar fundamental de qualquer prompt eficaz. A IA precisa entender exatamente 
              o que você deseja para fornecer uma resposta adequada.
            </p>
            ...
            <ExampleCard type="good">
              <p className="font-mono text-sm">
                "Explique o conceito de função quadrática para alunos do 9º ano, incluindo três exemplos práticos do cotidiano."
              </p>
            </ExampleCard>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Fornecer contexto adequado permite que a IA compreenda o cenário em que sua solicitação se insere.
            </p>
            ...
            <ExampleCard type="good">
              <p className="font-mono text-sm">
                "Sou professora de matemática do ensino fundamental II. Preciso criar uma atividade sobre 
                porcentagem para alunos do 7º ano com dificuldades em cálculos básicos. A atividade deve 
                ser lúdica e usar situações do dia a dia."
              </p>
            </ExampleCard>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Quanto mais específico for seu prompt, melhor será o resultado. Detalhe formato, tom, extensão e outros aspectos.
            </p>

            <div className="bg-card p-6 rounded-lg border border-border">
              <h4 className="font-semibold text-foreground mb-3">Componentes de Especificidade:</h4>
          ...
          <div className="bg-gradient-to-br from-primary/10 to-accent/10 p-8 rounded-xl border border-primary/20">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-background/50 p-4 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">Estabeleça o cenário e sua situação atual</p>
              </div>
              <div className="bg-background/50 p-4 rounded-lg">
                <h4 className="font-semibold text-primary mb-2">T - Tarefa</h4>
                <p className="text-sm text-muted-foreground">Defina claramente o que você precisa</p>
              </div>
              <div className="bg-background/50 p-4 rounded-lg">
                <h4 className="font-semibold text-primary mb-2">X - eXemplos</h4>
                <p className="text-sm text-muted-foreground">Forneça exemplos do resultado esperado</p>
              </div>
              <div className="bg-background/50 p-4 rounded-lg">
                <h4 className="font-semibold text-primary mb-2">E - Especificações</h4>
                <p className="text-sm text-muted-foreground">Detalhe requisitos técnicos e formato</p>
              </div>
            </div>
          </div>
...
Especificações: Nível de dificuldade médio, adequado para 8º ano, com gabarito ao final.`}
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Para tarefas complexas, divida seu prompt em etapas sequenciais. Isso ajuda a IA a processar 
              a informação gradualmente.
            </p>
...
Etapa 3: Desenvolva um plano de aula completo incorporando essas estratégias.`}
      ...
      >
        <div className="space-y-8">
          <div>
            <h3 className="text-2xl font-bold mb-4 text-foreground">1. Role-Playing (Atribuição de Papéis)</h3>
            <p className="text-muted-foreground mb-4">
            ...
            <div className="bg-card p-6 rounded-lg border border-border mb-4">
              ...
              <code className="text-sm text-primary">"Atue como [papel] com [características específicas]..."</code>
            </div>
          ...
          <div>
            <h3 className="text-2xl font-bold mb-4 text-foreground">2. Chain of Thought (Cadeia de Pensamento)</h3>
            <p className="text-muted-foreground mb-4">
            ...
            <ExampleCard type="good">
              <p className="font-mono text-sm">
                "Resolva este problema de matemática <strong>mostrando cada etapa do raciocínio</strong>: 
                Se um carro viaja a 80 km/h por 2,5 horas e depois a 100 km/h por 1,5 horas, 
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Forneça alguns exemplos do formato ou estilo que você deseja, e a IA aprenderá o padrão.
            </p>
...
Agora crie cinco novos exemplos seguindo o mesmo padrão.`}
          ...
          <div>
            ...
            <ExampleCard type="good">
              <p className="font-mono text-sm">
                "Crie um plano de aula sobre energia renovável para o 9º ano. <strong>Não inclua</strong> conteúdo 
                excessivamente técnico, <strong>não use</strong> jargão científico complexo e <strong>não faça</strong> referências 
                a cálculos avançados."
              </p>
            </ExampleCard>
          </div>
        </div>
...
- Sugestões de avaliação`}
          ...
          <div>
            <h3 className="text-2xl font-bold mb-4 text-foreground">Geração de Exercícios e Atividades</h3>
...
- Critérios de avaliação de sucesso`}
      ...
      >
        <div className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-lg mb-3 text-destructive">❌ Erro 1: Prompts Vagos</h4>
              <ExampleCard type="bad">
            ...
            <div>
              ...
              <ExampleCard type="good">
                <p className="font-mono text-sm">
                  "Explique três tendências atuais em tecnologia educacional para ensino fundamental II, 
                  incluindo exemplos práticos de implementação."
                </p>
              </ExampleCard>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-lg mb-3 text-destructive">❌ Erro 2: Excesso de Informação</h4>
              <ExampleCard type="bad">
                <p className="text-sm">Prompts com múltiplos parágrafos de contexto irrelevante que confundem a IA.</p>
              </ExampleCard>
            </div>
            <div>
              <h4 className="font-semibold text-lg mb-3 text-green-500">✓ Solução</h4>
              <ExampleCard type="good">
                <p className="text-sm">
                  Inclua apenas informações diretamente relevantes. Se o contexto for extenso, organize-o em tópicos claros.
                </p>
              </ExampleCard>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-lg mb-3 text-destructive">❌ Erro 3: Instruções Contraditórias</h4>
              <ExampleCard type="bad">
                <p className="font-mono text-sm">"Seja breve e detalhado" ou "Crie um texto formal e descontraído."</p>
              </ExampleCard>
            </div>
            <div>
              <h4 className="font-semibold text-lg mb-3 text-green-500">✓ Solução</h4>
              <ExampleCard type="good">
                <p className="text-sm">
                  Defina prioridades claras. "Escreva em tom profissional, mas use linguagem acessível e exemplos cotidianos."
                </p>
              </ExampleCard>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 p-6 rounded-lg border border-yellow-500/20">
            <h4 className="font-semibold text-foreground mb-3">Técnica de Refinamento Progressivo</h4>
            <p className="text-sm text-muted-foreground mb-3">
              Raramente o primeiro prompt produz o resultado perfeito. Use uma abordagem iterativa:
            </p>
            <ol className="space-y-2 text-sm text-muted-foreground">
              <li><strong className="text-foreground">1.</strong> Comece com um prompt básico mas claro</li>
              <li><strong className="text-foreground">2.</strong> Analise a resposta e identifique melhorias</li>
              <li><strong className="text-foreground">3.</strong> Refine o prompt com especificações adicionais</li>
              <li><strong className="text-foreground">4.</strong> Teste novamente e continue refinando</li>
            </ol>
          </div>
        </div>
      </ContentSection>
      ...
      >
        <div className="space-y-6">
          <p className="text-lg text-muted-foreground">
            Dominar a arte de criar prompts eficazes é uma habilidade transformadora na era digital. 
            Os princípios fundamentais são simples: <strong className="text-foreground">clareza, contexto, especificidade e estrutura</strong>. 
          ...
          <div className="grid md:grid-cols-2 gap-6 my-8">
            <div className="p-6 bg-gradient-to-br from-primary/10 to-accent/10 rounded-lg border border-primary/20">
              ...
              <p className="text-sm text-muted-foreground">
                A IA pode ser uma aliada poderosa na criação de materiais didáticos, personalização do ensino, 
                geração de atividades e muito mais. O segredo está em saber fazer as perguntas certas.
              </p>
            </div>
          ...
          <div className="text-center p-8 bg-gradient-to-r from-primary/20 via-accent/20 to-primary/20 rounded-lg border border-primary/30">
            ...
            <p className="text-muted-foreground">
              Mas é sua criatividade, conhecimento e experiência que transformam simples prompts em soluções extraordinárias.
            </p>
          </div>
        </div>
      </ContentSection>
